...
const features: IFeature[] = [
  ...
  },
  {
    ...
    content: 'Get quick consultations with experienced lawyers to discuss your legal concerns.',
    icon: MdAssignment,
  },
  {
    heading: 'Experts in Law ',
    content:
      'Access personalized and expert legal advice from our team of experienced lawyers and specialists.',
    icon: MdLocalHospital,
  },
  {
    heading: 'Access Legal Resources',
    content: 'Access a library of legal resources, FAQs, and  tips.',
    icon: MdLibraryBooks,
  },
];
